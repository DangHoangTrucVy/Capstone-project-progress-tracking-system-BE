...
3. **Generate a `workspace.dsl` file** following the Structurizr DSL syntax:
   ...
   - For DSL syntax details, read `.claude/skills/c4-architecture/references/structurizr-dsl-reference.md`
   - For a working example, read `.claude/skills/c4-architecture/examples/example-workspace.dsl`
